...
process.GlobalTag.toGet = cms.VPSet(
    cms.PSet(record = cms.string('TrackerAlignmentRcd'),
             ...
             connect = cms.string('sqlite_file:/afs/cern.ch/user/j/jfeingol/commonValidation/jfeingold/weakModes/test/radial_readData.db'),
    ),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('HitRes_realData_Radial.root')
)
