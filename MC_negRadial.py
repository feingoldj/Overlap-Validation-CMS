...
process.GlobalTag.toGet = cms.VPSet(
    cms.PSet(record = cms.string('TrackerAlignmentRcd'),
             ...
             connect = cms.string('sqlite_file:/afs/cern.ch/user/j/jfeingol/commonValidation/jfeingold/weakModes/test/MC_negRadial.db')
    ),
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('HitRes_MC_negRadial.root')
)
